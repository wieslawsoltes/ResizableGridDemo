...
namespace ResizableGridDemo.Controls
{
    ...
    public class GridSplitter : Thumb
    {
        ...
        private bool SetupDefinitionsToResize()
        {
            ...
            if (gridSpan == 1)
            {
                var splitterIndex = GetValueInternal(this, _resizeData.ResizeDirection == GridResizeDirection.Columns ?
                    Grid.ColumnProperty :
                    Grid.RowProperty);
                ...
                if (index1 >= 0 && index2 < count)
                {
                    ...
                    _resizeData.OriginalDefinition1Length =
                        _resizeData.Definition1.GetUserSizeValueCache(); // Save Size if user cancels.
                    ...
                    _resizeData.OriginalDefinition2Length =
                        _resizeData.Definition2.GetUserSizeValueCache(); // Save Size if user cancels.
        ...
        {
            return definition.GetUserSizeValueCache().IsStar;
        }
        ...
        private void GetDeltaConstraints(out double minDelta, out double maxDelta)
        {
            ...
            double definition2Min = _resizeData.Definition2.GetUserMinSizeValueCache();
            double definition2Max = _resizeData.Definition2.GetUserMaxSizeValueCache();
